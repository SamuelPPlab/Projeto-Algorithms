...
def compare_string(second_string, first_string_sorted):
    string_array = list(second_string)
    ...
    for i in range(len(string_array)):
        ...
        if string_array[i] != first_string_sorted[i]:
            return False
...
def is_anagram(first_string, second_string):
    ...
    return compare_string(second_string, first_string_sorted)
